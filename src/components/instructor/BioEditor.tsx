  ...
  return (
    <div className="space-y-2">
      ...
      <textarea
        ...
        className="w-full p-3 rounded-xl border border-white/10 bg-white/5 text-slate-200 text-sm outline-none focus:ring-4 focus:ring-blue-500/50 transition-all resize-none"
      />
      <div className="flex items-center justify-between gap-3">
        <span className="text-xs font-semibold text-slate-400">{bio.length} / {MAX_LENGTH}</span>
