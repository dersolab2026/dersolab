              ...
              {ODEV_TIPLERI.map((t) => (
                <button
                  ...
                  className={`rounded-lg border-2 border-[var(--cizgi)] px-2.5 py-1 text-xs font-bold transition-all ${
                    tip === t.deger ? 'bg-[var(--vurgu)] text-[var(--yazi-ters)]' : 'bg-[var(--yuzey-ic)] text-[var(--yazi)]'
                  }`}
                >
                  {t.etiket}
                </button>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full rounded-lg border-2 border-[var(--cizgi)] bg-[var(--yuzey-ic)] px-3 py-2 text-sm"
                >
