...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full border-4 border-[var(--cizgi)] bg-[#25D366] shadow-[0_4px_0_var(--golge)] transition-all hover:-translate-y-0.5 active:translate-y-0.5 active:shadow-none"
    >
