...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full border border-white/10 bg-[#25D366] shadow-[0_0_15px_rgba(0,0,0,0.3)] transition-all hover:-translate-y-0.5 active:translate-y-0.5 active:shadow-none"
    >
