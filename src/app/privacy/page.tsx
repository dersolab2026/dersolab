        ...
        <div className="space-y-6 leading-relaxed [&_h2]:text-xl [&_h2]:font-bold [&_h2]:mt-8 [&_h2]:mb-2 [&_p]:mb-3 [&_li]:mb-1 [&_ul]:list-disc [&_ul]:pl-6">
          ...
          <p>
            ...
            <a
              ...
              className="underline text-[#9C4A0C] font-semibold"
              target="_blank"
          ...
          <h2>10. İletişim</h2>
          <p>
            Gizlilikle ilgili sorularınız için bize <a href="mailto:destek@dersolab.com" className="underline text-[#9C4A0C] font-semibold">destek@dersolab.com</a> adresinden
            ulaşabilirsiniz.
          </p>
