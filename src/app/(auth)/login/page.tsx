  ...
  return (
    <AuthShell>
      <button
        ...
        className="w-full mb-6 py-3 px-4 bg-[var(--yuzey-ic)] text-[var(--yazi)] font-bold rounded-xl border-4 border-[var(--cizgi)] shadow-[0_4px_0_var(--golge)] active:translate-y-1 active:shadow-none transition-all flex items-center justify-center gap-3 disabled:opacity-60"
      >
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div>
          ...
          <div className="text-right mt-2">
            <Link href="/forgot-password" className="text-sm font-bold text-[var(--ikincil-yazi)] hover:underline">
              Şifremi Unuttum
            </Link>
          </div>
        </div>
      ...
      <div className="mt-6 text-center">
        <span className="text-[var(--yazi)]">Hesabın yok mu? </span>
        <Link href="/register" className="text-[var(--vurgu-yazi)] font-bold hover:underline">
          Kaydol
        </Link>
      </div>
    </AuthShell>
